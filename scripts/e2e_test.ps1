...
try {
    ...
    $packScenarios = @(
        ...
        @{ p = "database.bigquery"; c = "bq rm -r -f analytics_prod"; v = "block" },
        @{ p = "database.bigquery"; c = "bq query 'DROP SCHEMA mydataset CASCADE'"; v = "block" },
        @{ p = "database.bigquery"; c = "bq ls mydataset"; v = "allow" },
