...
//!
//! See `dcg_cli::perf` for the canonical budget definitions.

use std::fmt::Write as _;

use criterion::{BenchmarkId, Criterion, criterion_group, criterion_main};
use dcg_cli::packs::{REGISTRY, pack_aware_quick_reject};
use dcg_cli::{
...
struct HookBenchInputs {
    ...
    compiled_overrides: dcg_cli::config::CompiledOverrides,
...
fn bench_core_pipeline(c: &mut Criterion) {
    ...
    let allowlists = dcg_cli::LayeredAllowlist::default();
