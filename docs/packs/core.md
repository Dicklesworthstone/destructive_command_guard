...
| `rm-rf-reclaim-basename` | `^rm\s+-[a-zA-Z]*[rR][a-zA-Z]*f[a-zA-Z]*\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?(?:\s+\|$))+$` |
| `rm-fr-reclaim-basename` | `^rm\s+-[a-zA-Z]*f[a-zA-Z]*[rR][a-zA-Z]*\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?(?:\s+\|$))+$` |
| `rm-r-f-reclaim-basename` | `^rm\s+(-[a-zA-Z]+\s+)*-[rR]\s+(-[a-zA-Z]+\s+)*-f\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?(?:\s+\|$))+$` |
| `rm-f-r-reclaim-basename` | `^rm\s+(-[a-zA-Z]+\s+)*-f\s+(-[a-zA-Z]+\s+)*-[rR]\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?(?:\s+\|$))+$` |
| `rm-recursive-force-reclaim-basename` | `^rm\s+.*--recursive.*--force\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?(?:\s+\|$))+$` |
| `rm-force-recursive-reclaim-basename` | `^rm\s+.*--force.*--recursive\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?(?:\s+\|$))+$` |
| `rm-rf-updater-cache` | `^rm\s+-[a-zA-Z]*[rR][a-zA-Z]*f[a-zA-Z]*\s+(?:(?:~/\|/Users/(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)Library/Caches/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/?(?:\s+\|$))+$` |
| `rm-fr-updater-cache` | `^rm\s+-[a-zA-Z]*f[a-zA-Z]*[rR][a-zA-Z]*\s+(?:(?:~/\|/Users/(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)Library/Caches/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/?(?:\s+\|$))+$` |
| `rm-r-f-updater-cache` | `^rm\s+(-[a-zA-Z]+\s+)*-[rR]\s+(-[a-zA-Z]+\s+)*-f\s+(?:(?:~/\|/Users/(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)Library/Caches/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/?(?:\s+\|$))+$` |
| `rm-f-r-updater-cache` | `^rm\s+(-[a-zA-Z]+\s+)*-f\s+(-[a-zA-Z]+\s+)*-[rR]\s+(?:(?:~/\|/Users/(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)Library/Caches/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/?(?:\s+\|$))+$` |
| `rm-recursive-force-updater-cache` | `^rm\s+.*--recursive.*--force\s+(?:(?:~/\|/Users/(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)Library/Caches/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/?(?:\s+\|$))+$` |
| `rm-force-recursive-updater-cache` | `^rm\s+.*--force.*--recursive\s+(?:(?:~/\|/Users/(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)Library/Caches/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/?(?:\s+\|$))+$` |
| `find-delete-reclaim-basename` | `^(?![^\|;&]*[\\$`])find\s+(?:/(?:(?!\.\.(?:/\|\s\|$))[^/\s$\x22*?`'\\\[\]{};\|&()#~]+/)*(?:node_modules\|dist\|\.next\|coverage\|target\|build)/?\s+)+(?:-(?:min\|max)depth\s+\d+\s+){0,2}-delete\s*$` |
