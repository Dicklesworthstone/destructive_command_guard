...
undoes it). By hand, add to `~/.reasonix/settings.json` (`$REASONIX_HOME` or
`%APPDATA%\reasonix` if set/on Windows; or a project `.reasonix/settings.json`):
